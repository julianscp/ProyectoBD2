-- ===================================================================== --
-- Generar plan de ejecución sin indices                                 --
-- ===================================================================== --
...
EXPLAIN PLAN SET STATEMENT_ID = 'QFX_ANTES_INDICE' FOR
SELECT
    c.id_contenido,
    c.titulo,
...
SELECT *
FROM TABLE(DBMS_XPLAN.DISPLAY(NULL, 'QFX_ANTES_INDICE', 'BASIC +COST +ROWS +BYTES'));
